...
//std::unique_ptr<StaticLogger> StaticLogger::instance_ = nullptr;
//std::mutex StaticLogger::m_;

StaticLogger& StaticLogger::getInstance(){
    //std::lock_guard<std::mutex> lock(StaticLogger::m_);
//    if(!StaticLogger::instance_){
//        StaticLogger::instance_ = std::make_unique<Log4cplusImpl>();
//    }
//    return *StaticLogger::instance_;
