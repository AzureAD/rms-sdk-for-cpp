...
public:
    ...
    void			SkipLiterals(const CFX_ByteString& str);
...
{
public:
    explicit CXML_Composer(FX_BOOL KeepSpecialCode = FALSE) : m_KeepSpecialCode(KeepSpecialCode) {}
    void	Compose(CXML_Element* pElement, IFX_FileWrite *pFileWrite, CFX_ByteString &xmlStr);
    CFX_ByteTextBuf	m_Buf;
    FX_BOOL			m_KeepSpecialCode;
private:
    void			ComposeElement(CXML_Element* pElement, IFX_FileWrite *pFileWrite);
};
