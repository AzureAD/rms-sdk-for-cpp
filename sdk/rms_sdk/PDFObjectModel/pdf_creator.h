...
class CustomCryptoHandler : public CPDF_CryptoHandler {
 ...
 public:
  ...
  virtual FX_DWORD EncryptGetSize(
      FX_DWORD objnum,
      FX_DWORD version,
      FX_LPCBYTE src_buf,
      FX_DWORD src_size);

  virtual FX_BOOL EncryptContent(
      FX_DWORD objnum,
      FX_DWORD version,
      FX_LPCBYTE src_buf,
      FX_DWORD src_size,
  ...
  virtual FX_BOOL ProgressiveEncryptStart(
      FX_DWORD objnum,
      FX_DWORD version,
      FX_DWORD raw_size,
      FX_BOOL flate_encode);

  virtual FX_BOOL ProgressiveEncryptContent(
      FX_INT32 objnum,
      FX_DWORD version,
      FX_LPCBYTE src_buf,
      FX_DWORD src_size,
...
class CustomProgressiveEncryptHandler : public CPDF_ProgressiveEncryptHandler {
 public:
  ...
  virtual FX_LPVOID EncryptStart(
      FX_DWORD objnum,
      FX_DWORD gennum,
      FX_DWORD raw_size,
      FX_BOOL flate_encode);

  virtual FX_BOOL EncryptStream(
      FX_LPVOID context,
      FX_LPCBYTE src_buf,
      FX_DWORD src_size,
