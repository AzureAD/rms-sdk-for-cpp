...
CFX_BasicArray::CFX_BasicArray(const CFX_BasicArray& other)
    : m_pData(NULL)
    , m_nSize(0)
    , m_nMaxSize(0)
    , m_nGrowBy(0)
    , m_nUnitSize(other.m_nUnitSize)
{
    Copy(other);
}
CFX_BasicArray& CFX_BasicArray::operator=(const CFX_BasicArray& other)
{
    Copy(other);
    return *this;
}
