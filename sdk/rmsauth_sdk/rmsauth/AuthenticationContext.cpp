...
{
   StaticLogger::Info(Tag(),"AuthenticationContext");
...
{
    StaticLogger::Info(Tag(),"acquireToken");
...
{
    StaticLogger::Info(Tag(),"acquireTokenCommonAsync");
...
{
    StaticLogger::Info(Tag(),"createWebAuthenticationDialog");
