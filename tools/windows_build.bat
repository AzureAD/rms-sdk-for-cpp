...
cd ..\sdk
call C:\Qt\5.7\msvc2015\bin\qmake.exe sdk.pro -spec win32-msvc2015 "CONFIG+=debug_and_release" 
call C:\Qt\Tools\QtCreator\bin\jom.exe clean
call C:\Qt\Tools\QtCreator\bin\jom.exe
cd ..\samples
call C:\Qt\5.7\msvc2015\bin\qmake.exe samples.pro -spec win32-msvc2015 "CONFIG+=debug_and_release" 
call C:\Qt\Tools\QtCreator\bin\jom.exe clean
call C:\Qt\Tools\QtCreator\bin\jom.exe
cd ..\bin
copy tests\*UnitTest* .
xcopy C:\Qt\5.7\msvc2015\bin\*.dll .
